...
async function downloadPDF() {
    ...
    logoImg.onload = async function () {
        ...
        await addPDF(document.getElementById('pdfFormacionAcademica'));
        await addPDF(document.getElementById('pdfExperiencia'));
        await addPDF(document.getElementById('pdfExperienciaDocente'));
